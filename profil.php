...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST">
                     <input type="password" name="pas1" placeholder="Password Baru" class="input-control"  required>
                     <input type="password" name="pas2" placeholder="Konfirmasi Password" class="input-control"  required>
                ...
                <?php
                    if(isset($_POST['ubah_password'])){
                            ...
                            if($pass2 != $pass1){
                                echo '<script>("Konfirmasi password baru tidak sesuai")</script>';
                            }else{
